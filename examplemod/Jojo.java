...
public class Jojo  extends EntityRenderer<Bullet>
{
    private static final ResourceLocation rec = new ResourceLocation(ExampleMod.MODID,"textures/entity/projectiles/bullet.png");
    private static final RenderType RENDER_TYPE = RenderType.entityCutoutNoCull(rec);
    public Jojo(EntityRendererProvider.Context p_174414_) {
        super(p_174414_);
    }


    @Override
    public void render(Bullet p_114080_, float p_114081_, float p_114082_, PoseStack p_114083_, MultiBufferSource p_114084_, int p_114085_) {
        p_114083_.pushPose();
    ...
    @Override
    public ResourceLocation getTextureLocation(Bullet p_114482_) {
        return new ResourceLocation(ExampleMod.MODID,"textures/entity/projectiles/bullet.png");
    }
}
